{
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      exec = [
        # Set wallpaper
        "${pkgs.swaybg}/bin/swaybg --image ${config.home.homeDirectory}/Pictures/Wallpapers/w1f7O1V.jpeg"
      ];
  ...
  xdg.configFile."swaylock/config".text = ''
    ...
    image=/home/thomasung/Pictures/Wallpapers/totoro.jpeg
  ...
  programs.fuzzel = {
    ...
    settings = {
      main = {
        terminal = "/snap/ghostty/current/bin/ghostty";
        layer = "overlay";
        width = 30;
